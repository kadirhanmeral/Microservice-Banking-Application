...
public class UserServiceImpl implements UserService {
    ...
    public Response createUser(CreateUser userDto) {
        ...
        Optional<User> identityUser = userRepository.findByIdentity(userDto.getIdentity());
        if (identityUser.isPresent()){
            throw new ResourceConflictException("This identity number is already registered as a user");
